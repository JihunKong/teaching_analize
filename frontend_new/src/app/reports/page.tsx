  ...
  return (
    <div className="container">
      ...
      <div className="status status-info" style={{ marginTop: '30px' }}>
        ...
        실제 분석을 진행하려면 <a href="/transcription" style={{ color: '#0c5460', fontWeight: 'bold' }}>전사 페이지</a>에서 
        YouTube URL을 입력하거나 <a href="/analysis" style={{ color: '#0c5460', fontWeight: 'bold' }}>분석 페이지</a>에서 
        텍스트를 직접 입력하세요.
      </div>
    </div>
  )
