              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleSettingChange('autoDownload', checked as boolean)}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleSettingChange('enablePreview', checked as boolean)}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleSettingChange('showProgressDialog', checked as boolean)}
                  />
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => handleSettingChange('keepHistory', checked as boolean)}
                  />
