#!/usr/bin/env python3
"""
Simple HTTP Proxy Server for AIBOA Frontend
Serves static HTML and proxies API calls to backend services
"""
...
if __name__ == "__main__":
    ...
    print(f"🚀 Frontend proxy server running on port {port}")
